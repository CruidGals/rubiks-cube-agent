...
ep_moves = {
    ...
    "x'": [8, 0, 9, 2, 10, 4, 11, 6, 7, 5, 1, 3],
    'x2': [4, 5, 6, 7, 0, 1, 2, 3, 10, 11, 8, 9],

    'y':  [3, 0, 1, 2, 4, 5, 6, 7, 9, 10, 11, 8],
    "y'": [1, 2, 3, 0, 5, 6, 7, 4, 11, 8, 9, 10],
    'y2': [2, 3, 0, 1, 6, 7, 4, 5, 11, 10, 9, 8],

    'z':  [2, 9, 6, 10, 0, 8, 4, 11, 1, 5, 7, 3],
    "z'": [4, 8, 0, 11, 6, 9, 2, 10, 5, 1, 3, 7],
    'z2': [6, 7, 4, 5, 2, 3, 0, 1, 9, 8, 11, 10]
}
```
